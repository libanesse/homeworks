...
function endGame() {
  ...
  clearInterval(timer);
    // mark the answers in the correct and incorrect functions
    //make input forms appear, get initials and score and set in local storage
    //folow similar proccess to question making to display high scores
